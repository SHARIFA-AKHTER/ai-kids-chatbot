...
export const ChatWindow: React.FC<ChatWindowProps> = ({ messages, loading }) => {
  return (
    <div className="w-full flex-1 bg-white rounded-2xl md:rounded-3xl shadow-xl p-4 md:p-6 overflow-y-auto min-h-[350px] max-h-[55vh] md:max-h-[60vh] flex flex-col gap-3 md:gap-4 border-2 border-orange-200">
      {messages.length === 0 && (
