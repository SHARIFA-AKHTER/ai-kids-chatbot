        ...
        <div className="w-full max-w-4xl flex flex-col flex-1 h-full justify-between gap-4 mt-2">
            ...
            <form onSubmit={handleSubmit} className="w-full flex gap-2 items-center">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="bg-linear-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-black h-12 md:h-15 px-6 md:px-8 rounded-full shadow-md transition-transform active:scale-95 text-base md:text-lg disabled:opacity-50 flex items-center justify-center"
                >
                    Go! 🚀
                </button>
            </form>
